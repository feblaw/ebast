...
namespace App.Web.Areas.Admin.Controllers.Export
{
    ...
    [Area("Export")]
    [Authorize]
    public class ActivityCodeController : BaseController<ActivityCode, IActivityCodeService, ActivityCodeViewModel, ActivityCodeModelForm, Guid>
    {
        ...
        public override IActionResult Index()
        {
            ...
            string sFileName = @"report/ActivityCode.xlsx";
            ...
            using (ExcelPackage package = new ExcelPackage(file))
            {
                ...
                int i = 0;
                int index = 1;
                worksheet.Cells[index, i += 1].Value = "Activity Code";
