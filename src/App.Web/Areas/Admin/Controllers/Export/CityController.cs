...
namespace App.Web.Areas.Admin.Controllers.Export
{
    [Area("Export")]
    [Authorize]
    public class CityController : BaseController<City, ICityService, CityViewModel, CityModelForm, Guid>
    {
        ...
        public CityController(
            ...
            ICityService service, IUserHelper userHelper) : 
        ...
        public override IActionResult Index()
        {
            ...
            string sFileName = @"report/City.xlsx";
            ...
            using (ExcelPackage package = new ExcelPackage(file))
            {
                ...
                int i = 0;
                int index = 1;
                worksheet.Cells[index, i += 1].Value = "City Name";
