...
namespace App.Web.Migrations
{
    ...
    [Migration("20170806115740_adding status closed network")]
    partial class addingstatusclosednetwork
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("App.Domain.Models.Core.AttendanceRecord", b =>
                {
                    ...
                    b.Property<Guid>("AttendaceExceptionListId");
                    ...
                    b.HasIndex("AttendaceExceptionListId");
            ...
            modelBuilder.Entity("App.Domain.Models.Core.SrfRequest", b =>
                {
                    ...
                    b.Property<DateTime?>("DateApproveStatusFive");

                    b.Property<DateTime?>("DateApproveStatusFour");

                    b.Property<DateTime?>("DateApproveStatusOne");

                    b.Property<DateTime?>("DateApproveStatusSix");

                    b.Property<DateTime?>("DateApproveStatusThree");

                    b.Property<DateTime?>("DateApproveStatusTwo");
            ...
            modelBuilder.Entity("App.Domain.Models.Core.TacticalResource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("App.Domain.Models.Core.AttendanceRecord", b =>
                {
                    b.HasOne("App.Domain.Models.Core.AttendaceExceptionList", "AttendaceExceptionList")
                        .WithMany("Record")
                        .HasForeignKey("AttendaceExceptionListId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("App.Domain.Models.Core.SrfEscalationRequest", b =>
                {
                    ...
                    b.HasOne("App.Domain.Models.Core.SrfRequest", "SrfRequest")
                        .WithOne("Escalation")
                        .HasForeignKey("App.Domain.Models.Core.SrfEscalationRequest", "SrfId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("App.Domain.Models.Core.TicketInfo", b =>
                {
                    b.HasOne("App.Domain.Models.Core.Claim", "Claim")
                        .WithOne("Ticket")
                        .HasForeignKey("App.Domain.Models.Core.TicketInfo", "ClaimId")
                        .OnDelete(DeleteBehavior.Cascade);
